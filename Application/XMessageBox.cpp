...
{
	IDS_ABORT,            (TCHAR*) _T("&Abort"),
	IDS_CANCEL,           (TCHAR*) _T("Cancel"),
	IDS_CONTINUE,         (TCHAR*) _T("&Continue"),
	IDS_DONOTASKAGAIN,    (TCHAR*) _T("Don't ask me again"),
	IDS_DONOTTELLAGAIN,   (TCHAR*) _T("Don't tell me again"),
	IDS_DONOTSHOWAGAIN,   (TCHAR*) _T("Don't show again"),
	IDS_HELP,             (TCHAR*) _T("&Help"),
	IDS_IGNORE,           (TCHAR*) _T("&Ignore"),
	IDS_IGNOREALL,        (TCHAR*) _T("I&gnore All"),
	IDS_NO,               (TCHAR*) _T("&No"),
	IDS_NOTOALL,          (TCHAR*) _T("N&o to All"),
	IDS_OK,               (TCHAR*) _T("OK"),
	IDS_REPORT,           (TCHAR*) _T("Re&port"),
	IDS_RETRY,            (TCHAR*) _T("&Retry"),
	IDS_SKIP,             (TCHAR*) _T("&Skip"),
	IDS_SKIPALL,          (TCHAR*) _T("S&kip All"),
	IDS_TRYAGAIN,         (TCHAR*) _T("&Try Again"),
	IDS_YES,              (TCHAR*) _T("&Yes"),
	IDS_YESTOALL,         (TCHAR*) _T("Y&es to All")
};
...
static TCHAR *szAlphabet = (TCHAR*) _T("ABCDEFGHIJKLMNOPQRSTUVWXYZ")
						   _T("0123456789")
...
static DWORD ReadRegistry(LPCTSTR lpszCompanyName, LPCTSTR lpszKey)
{
	...
	TCHAR * szRegPath = (TCHAR*) _T("Software\\");
